...
public class GestNiveau : MonoBehaviour
{
    ...
    [Header("INTERFACE")] //Entete de section pour les données et l'interface
    ...
    [Header("NIVEAU")] //Entete de section pour les caractéristiques du niveau
    ...
    void Awake()
    {
        ...
        else
        {
            ...
            Debug.LogWarning("Destruction d'un instance superflue de GestNiveau");
    ...
    public void RecupererTresor(int points) //ne pas oublier d'ajouter le parametre
    {
        ...
        if (_nbTresorsRecup == _nbTresorsIni) _iNavig.AllerNiveauSuivant(); //si tous les trésors ont ete ramasses changer de scene avec la methode des infos de navigation
    }
    ...
    public void PerdreVie()
    {
        ...
        if(_iJoueur.vie<1) _iNavig.AllerFin(); //si mort pour vrai, aller a la scene de fin
    }
}